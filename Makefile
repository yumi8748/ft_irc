...
SRC_DIR := src
SOURCES := main.cpp Channel.cpp Client.cpp Server.cpp fredcommandParsing.cpp cmdNick.cpp cmdPass.cpp cmdQuit.cpp cmdUser.cpp cmdPrivmsg.cpp Authentification.cpp cmdJoin.cpp cmdCap.cpp
